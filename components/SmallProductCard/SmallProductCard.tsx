...
export default function SmallProductCard() {
  ...
  return (
    <Link
      href={"/login"}
      className="bg-white group relative overflow-hidden transition-smooth outline-1 w-full max-w-sm hover:outline-gray-300 outline-gray-200 h-fit outline flex flex-row"
    >
